...
#获取cookie
def getCookie():
	cookies = 'JSESSIONID=24C1DA3D3F3F7950AC78A4C3D0F54A9E; _ga=GA1.2.1337450491.1567735190; _gid=GA1.2.1704065071.1567735190'
	jar = dict()
...
def departmentList(area):
	...
	departmentListUrl= 'https://hytwechat.cd120.com/hyt/wechat/departmentList?area='+area+'&today=1&hisCode=HID0101'
...
def doctorsDetail(a,b):
	...
	for i in scheduleList:
		...
		print(detailUser,detailJson['resourceId'],detailJson['serviceDate'],detailJson['timeRang'],detailJson['regAvailable'])
